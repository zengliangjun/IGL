...
from humanoidverse.envs.locomotion.rewards import body, command, feet, robotstatus
locomotion_rewards_registry['body_rewards'] = body.UpperBodyRewards
...
locomotion_rewards_registry['robotstatus_rewards'] = robotstatus.StatusRewards
